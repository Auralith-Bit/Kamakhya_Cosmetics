        ...
        >
            <div className="page-container py-14 sm:py-16 lg:py-20">
                <nav aria-label="Breadcrumb" className="flex flex-wrap items-center gap-x-2 gap-y-1 text-[#2E3192] font-serif mb-3">
                    ...
                    <span className="text-sm sm:text-base">Become a Distributor </span>
                ...
                <h1 className="text-3xl sm:text-4xl md:text-4xl font-serif text-[#2E3192] font-playfair mb-3 leading-tight">
                   Become a Kamakhya distributor
                </h1>

                <p className="text-[#70768A] max-w-md text-sm sm:text-base font-poppins ">
                    We appoint distributors to grow our brands in their markets. Apply below to explore partnership opportunities.
                </p>
            </div>
        </div>
    )
