...
const ShinePromo = () => (
  <section id="shine-other-brands" className="ob-sec">
    <style>{`
      /* ============ DESKTOP ≥1024 — identical to Shine's OtherBrands ============ */
      ...
      .ob-btn:hover{background:transparent;color:#176B22;}
      ...
      /* ============ TABLET 640–1023 — capped panel + pill CTA (identical to Shine) ============ */
      @media (min-width:640px) and (max-width:1023px){
        ...
        .ob-btn{
          ...
          height:52px;
          padding:0 32px;
          border:2px solid #176B22;   /* ✅ Shine green pill */
          border-radius:10px;
          font-size:15px;
          gap:10px;
        }
