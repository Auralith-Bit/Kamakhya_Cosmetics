  ...
  return (
    <section id="shine-best-sellers" className="bs-sec">
      ...
      <header className="bs-head">
        ...
        <p className="bs-sub">
          Discover our most-loved beauty essentials trusted by thousands for radiant skin, flawless makeup,
          and healthy hair—crafted with premium ingredients and exceptional care.
        </p>
      </header>
