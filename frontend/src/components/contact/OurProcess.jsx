  ...
  return (
    <section id="shine-faq" className="fq-sec">
      <style>{`
        ...
        /* ============ TABLET 640–1023 — capped, centered columns + fixed px ============ */
        @media (min-width:640px) and (max-width:1023px){
          .fq-sec{padding:64px 48px 72px;}

          /* header */
          .fq-tag{font-size:13px;}
          .fq-title{font-size:28px;margin-top:8px;}
          .fq-vector{width:120px;margin:12px auto 0;}
          .fq-sub{font-size:14px;line-height:1.6;margin:12px auto 0;max-width:640px;}

          /* ✅ accordion capped + centered (was full-bleed) */
          .fq-list{
      ...
      <p className="fq-tag">Our Process</p>
      <h2 className="fq-title">How we work</h2>
      ...
      <p className="fq-sub">
        ...
        <br />
        to ensure every customer receives the best possible experience.
      </p>
