  ...
  return (
    <section id="shine-philosophy" className="bp-sec">
      <style>{`
        ...
        .bp-photo{
          position:absolute;
          top:5.6646vw; left:60.875vw;
          width:31.6042vw; height:35.25vw;
          object-fit:fill; object-position:center;
          display:block; background:#F7F5F0; cursor:pointer;
        }

        .bp-play{
          position:absolute;
          left:74.5vw; top:22vw;
        ...
        .bp-play.is-hidden { opacity: 0; pointer-events: none; transform: scale(0.8); }
        .bp-sec:hover .bp-play.is-hidden { opacity: 1; pointer-events: auto; transform: scale(1); }
        .bp-play:hover { transform: scale(1.1); box-shadow:0 0.3125vw 1.0417vw rgba(0,0,0,0.2), 0 0.625vw 1.6667vw rgba(0,0,0,0.15); }
        .bp-sec:hover .bp-play.is-hidden:hover { transform: scale(1.1); }

        .bp-play svg { width:45%; height:45%; color:#176B22; display:block; }
        .bp-play .icon-play { margin-left:10%; }

        .bp-copy{position:absolute;left:8.8542vw;top:6.9271vw;width:45.8333vw;}
        .bp-tag{color:#E38F2E;font-family:${sans};font-size:0.8333vw;margin-top:-1.25vw;font-weight:600;letter-spacing:0.18em;text-transform:uppercase;}
        ...
        .bp-card{position:relative;width:12.5vw;min-height:14.65vw;height:auto;background:#FBFBFD;border:0.0521vw solid #ECECF2;border-radius:0.625vw;box-shadow:0 0.625vw 1.5625vw rgba(43,46,126,0.07);display:flex;flex-direction:column;align-items:center;text-align:center;padding:1.8vw 1.35vw;overflow:hidden;transition:box-shadow .3s ease, border-color .3s ease;}
        ...
        .bp-corner.tl{top:0;left:0;} .bp-corner.br{bottom:0;right:0;transform:rotate(180deg);}
        ...
        .bp-btn{position:absolute;left:8.8542vw;top:36.8vw;width:17.8125vw;height:2.8646vw;border-radius:0.3646vw;background:#176B22;border:0.1563vw solid #176B22;color:#fff;font-family:${sans};font-size:0.8854vw;letter-spacing:0.05em;cursor:pointer;transition:background .2s;display:flex;align-items:center;justify-content:center;gap:0.5208vw;text-decoration:none;}
        .bp-btn:hover{background:#0f5217;} .bp-btn svg{width:0.4688vw;height:0.7292vw;flex-shrink:0;}
        ...
        .bp-btn2:hover{background:#eef0e9;} .bp-btn2 svg{width:1.0417vw;height:1.0417vw;flex-shrink:0;}
        ...
        @media (max-width:1023px){
          ...
          .bp-photo{
            ...
            margin-top:6vw; border-radius:2vw;
          }
          
          /* ✅ Button acts as a grid item, stacking in the exact same cell as the video */
          .bp-play{
            position:static; left:auto; top:auto;
            grid-column:1; grid-row:3;
            justify-self:center; align-self:center;
            width:clamp(56px, 12vw, 80px); height:clamp(56px, 12vw, 80px);
            margin-top:6vw; /* Matches video margin so they overlap perfectly */
            z-index:2;
          }
        ...
        @media (min-width:640px) and (max-width:1023px){
          .bp-sec{
            ...
            column-gap:3vw;
            row-gap:4vw; /* ✅ FIX: Adds proper vertical spacing between grid rows */
          }
          .bp-copy,.bp-cards,.bp-photo,.bp-play{grid-column:1 / -1;}

          /* Override base margin-tops since we use row-gap now */
          .bp-cards, .bp-photo, .bp-play, .bp-btn, .bp-btn2 { margin-top: 0; }
          ...
          .bp-btn{font-size:15px;grid-column:1;grid-row:4;}
          .bp-btn2{grid-column:2;grid-row:4;}
      ...
      <Link to="" className="bp-btn bp-btn2">
        Download Catalog
