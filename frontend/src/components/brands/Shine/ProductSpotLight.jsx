...
const ProductSpotlight = () => {
  ...
  return (
    <section id="shine-spotlight" className="psx-sec">
      ...
      <h2 className="psx-title">Cleaning, Perfected With Care</h2>
      <img className="psx-vector" src={vector1} alt="" aria-hidden="true" />
      <p className="psx-sub">
        <span>From kitchens to laundry and everyday surfaces, our trusted collection delivers reliable
          <br/>
          cleaning with refreshing results.</span>
      </p>
