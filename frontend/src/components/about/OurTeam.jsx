...
const GoldenWave = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 172 24" fill="none" className="ot-wave" aria-hidden="true">
...
const OurTeam = () => (
  <section id="our-team" className="ot-sec">
    <style>{`
      ...
      .ot-head{text-align:center;padding:0 8vw;}
      .ot-tag{color:#E38F2E;font-family:${sans};font-size:0.8333vw;font-weight:600;
        letter-spacing:0.18em;text-transform:uppercase;}
      .ot-title{margin-top:0.6vw;color:#2E3192;font-family:${serif};
        font-size:1.5625vw;font-weight:700;line-height:1.2;}
      .ot-wave{display:block;width:9vw;height:auto;margin:0.5vw auto 0;}
      .ot-p{margin-top:1vw;color:#666666;font-family:${sans};font-size:1vw;line-height:1.4583vw;}
      .ot-p2{display:block;}
      ...
      .ot-name{margin-top:1.4vw;color:#4d4d4d;font-family:${serif};
        font-size:1.0417vw;font-weight:700;line-height:1.25;}
      .ot-role{margin-top:0.35vw;color:#9a9a9a;font-family:${sans};
